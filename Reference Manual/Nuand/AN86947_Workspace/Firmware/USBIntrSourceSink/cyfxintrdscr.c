/*
 ## Cypress USB 3.0 Platform header file (cyfxintrdscr.c)
 ## ===========================
 ##
...
/* This file contains the USB enumeration descriptors for the interrupt source sink application example.
...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    (CY_FX_INTR_BURST_SIZE - 1),    /* Max no. of packets in a burst (0-2) - 0: burst 1 packet at a time */
    0,          		    /* Number of bursts: Should be zero. */
    0x00,(0x04 * CY_FX_INTR_BURST_SIZE), /* Bytes per interval : 1024 * burst */
    ...
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
    (CY_FX_INTR_BURST_SIZE - 1),    /* Max no. of packets in a burst(0-15) - 0: burst 1 packet at a time */
    0,          	            /* Number of bursts: Should be 0. */
    0x00,(0x04 * CY_FX_INTR_BURST_SIZE)  /* Bytes per interval : 1024 * burst */
};
...
const uint8_t CyFxUSBHSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
    CY_FX_EP_PRODUCER,              /* Endpoint address and description */
    CY_U3P_USB_EP_INTR,             /* Intr endpoint type */
    0x00,0x04,                      /* Max packet size = 1024 bytes */
