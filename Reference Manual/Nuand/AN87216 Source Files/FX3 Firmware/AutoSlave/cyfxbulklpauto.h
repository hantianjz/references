...
/* Set CY_FX_SL_GPIF_16_32BIT_CONF_SELECT = 0 for 16 bit GPIF data bus.
 * Set CY_FX_SL_GPIF_16_32BIT_CONF_SELECT = 1 for 32 bit GPIF data bus.
 */
#define CY_FX_GPIF_16_32BIT_CONF_SELECT (1)

#define CY_FX_DMA_BUF_COUNT      (16)                       /* slave Bulk channel buffer count */
#define CY_FX_DMA_TX_SIZE        (0)                       /* DMA transfer size is set to infinite */
#define CY_FX_THREAD_STACK       (0x0400)                   /* Slave Bulk application thread stack size */
#define CY_FX_THREAD_PRIORITY    (8)                        /* Slave Bulk application thread priority */
...
#define CY_FX_PRODUCER_USB_SOCKET        CY_U3P_UIB_SOCKET_PROD_1    /* Socket 1 is producer */
