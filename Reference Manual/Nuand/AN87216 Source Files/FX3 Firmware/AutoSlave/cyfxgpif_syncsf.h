/*
 * Project Name: sync_slave_fifo_2bit_editable_latestGPIF.cyfx
 * Time : 11/24/2015 18:40:38
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_SYNC_SLAVE_FIFO_2BIT_EDITABLE_LATESTGPIF_CYDSN_
#define _INCLUDED_SYNC_SLAVE_FIFO_2BIT_EDITABLE_LATESTGPIF_CYDSN_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x1E086001,0x000302C4,0x80000000},{0x4E040704,0x00000300,0xC0000100}},
    ...
    {{0x00000000,0x00000000,0x00000000},{0x4E040704,0x00000300,0xC0000100}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x00011100,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
    0x0000FFAF,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
    0x000000DF,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_POLARITY */
...
#endif   /* _INCLUDED_SYNC_SLAVE_FIFO_2BIT_EDITABLE_LATESTGPIF_CYDSN_ */
